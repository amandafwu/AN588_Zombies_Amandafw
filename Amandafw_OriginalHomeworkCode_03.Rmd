...
sz_se
upper <- mean(sz) + qnorm(0.975, mean = 0, sd = 1) * sz_se
lower <- mean(sz) + qnorm(0.025, mean = 0, sd = 1) * sz_se  #ci with normal distribution
ci <- c(lower, upper)
ci
...
sy_se
upper <- mean(sy) + qnorm(0.975, mean = 0, sd = 1) * sy_se
lower <- mean(sy) + qnorm(0.025, mean = 0, sd = 1) * sy_se  #ci with normal distribution
ci <- c(lower, upper)
ci
```
